...
export interface Translate {
    <T = string>(i18nKey: string | TemplateStringsArray, query: TranslationQuery | null | undefined, options: {
        returnObjects?: boolean;
        fallback?: string | string[];
    }): T;
    (i18nKey: string | TemplateStringsArray, query: TranslationQuery | null | undefined): string;
