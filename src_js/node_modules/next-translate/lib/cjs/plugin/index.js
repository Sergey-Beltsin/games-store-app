...
function nextTranslate(nextConfig) {
    ...
    var dir = path.resolve(path.relative(process.cwd(), process.env.NEXT_TRANSLATE_PATH || '.'));
    var arePagesInsideSrc = fs.existsSync(path.join(dir, 'src/pages'));
    var i18n = nextConfig.i18n || {};
    var _a = require(path.join(dir, 'i18n')), locales = _a.locales, defaultLocale = _a.defaultLocale, _b = _a.loader, loader = _b === void 0 ? true : _b, pages = _a.pages, logger = _a.logger, restI18n = __rest(_a, ["locales", "defaultLocale", "loader", "pages", "logger"]);
    ...
    var pagesPath = path.join(dir, arePagesInsideSrc ? '/src/pages' : '/pages');
