...
function loadNamespaces(config) {
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    conf = __assign(__assign({}, getConfig_1.default()), config);
                    __lang = conf.locale || ((_a = conf.router) === null || _a === void 0 ? void 0 : _a.locale) || conf.defaultLocale || '';
                    if (!conf.pathname) {
                    ...
                    return [4, getPageNamespaces_1.default(conf, page, conf)];
                case 1:
                    namespaces = _b.sent();
